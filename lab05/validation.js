...
function validatePassword(passid, min, max) {
    var error ="";
    var illegalChars = /[\W_]/; //allow only letter and numbers

    if(passid.value ==""){
        passid.style.background = 'Yellow';
        error = "การุณาป้อน Password\n";
        alert(error);
        passid.focus();
        return false;
    ...
    function allnumeric(uzip){
        ...
        if(uzip.value.match(numbers)){
            ...
            alert('ZIP ต้องเป็นตัวเลขเท่านั้น');
            uzip.focus();
            return false;
        }
    }
